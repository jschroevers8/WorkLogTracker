...
import worklogtracker.presentation.auth.registerRoute
import worklogtracker.presentation.notification.getNotificationsRoute
import worklogtracker.presentation.notification.markNotificationReadRoute
import worklogtracker.presentation.project.createProjectRoute
import worklogtracker.presentation.project.getProjectsRoute
import worklogtracker.presentation.project.updateProjectRoute
import worklogtracker.presentation.report.getProjectReportRoute
import worklogtracker.presentation.report.getUserReportRoute
import worklogtracker.presentation.sync.getPendingSyncsRoute
import worklogtracker.presentation.sync.pushSyncRoute
import worklogtracker.presentation.task.assignTaskRoute
import worklogtracker.presentation.task.createTaskRoute
import worklogtracker.presentation.task.getTasksRoute
import worklogtracker.presentation.task.getUpcomingDeadlinesRoute
import worklogtracker.presentation.task.updateTaskStatusRoute
import worklogtracker.presentation.worklog.createWorkLogRoute
...
fun Application.configureRouting() {
    ...
    val assignTaskUseCase = AssignTaskUseCase(taskRepository, userRepository, createNotificationUseCaseInstance)
