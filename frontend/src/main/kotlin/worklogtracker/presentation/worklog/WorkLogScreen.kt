...
fun WorkLogScreen(
    ...
    Scaffold(
        ...
        Column(
            ...
            val selectedTask = uiState.tasks.find { it.id == uiState.selectedTaskId }
            ...
            ExposedDropdownMenuBox(
                ...
                TextField(
                    value = selectedTask?.title ?: "Selecteer een taak",
                    onValueChange = {},
                    readOnly = true,
            ...
            Button(
                ...
                modifier = Modifier.fillMaxWidth(),
                enabled = uiState.selectedTaskId != null && !uiState.loading
            ) {
                if (uiState.loading) {
